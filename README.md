...
4. Name the Lambda Function "Phone-Assistant-Skill".
...
2. Set "PhoneAssistant" as the skill name and "phone assistant" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, Ask Phone Assistant  what is the extension number for someone."
